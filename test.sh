...
assert_contains "FORK_DIR_PATTERN='*_feature_*'" "$sh_env_out" "fork sh includes FORK_DIR_PATTERN in command"
...
assert_contains "FORK_DIR_PATTERN='*_feature_*'" "$sh_env_fish_out" "fork sh fish includes FORK_DIR_PATTERN in command"
